...
export const AnnouncementBanner: React.FC<AnnouncementBannerProps> = ({
  ...
  return (
    <div 
      ...
      className="w-full max-w-full overflow-x-hidden relative bg-slate-950/85 backdrop-blur-md border-b border-slate-800/60 text-slate-100 shadow-sm transition-all animate-fadeIn"
    >
